...
### 1. Use the AnnotationHub package to obtain data on "CpG Islands" in the human genome. **How many islands exists on the autosomes?**
...
# obtained the cell line information(E003) from: https://www.ncbi.nlm.nih.gov/research/snpdelscore/tissues/
```{r echo=TRUE, message=FALSE, warning=FALSE}
